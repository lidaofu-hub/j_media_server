package com.ldf.media.module.transcode;
...
public class Transcode {
    private TranscodeParam param;

    private String pushUrl;

    private Boolean isStop = false;

    public Transcode(TranscodeParam param, String pushUrl) {
        this.param = param;
    ...
    public void start() {
        ...
        while (!isStop && (ret = avformat.av_read_frame(iFmtCtx, srcPacket)) == 0) {
